...
export default function AtsScanner() {
  ...
  const handleFile = async (file) => {
    ...
    if (lower.endsWith(".pdf")) {
      setUploadError("PDF upload needs server-side processing — coming soon. For now, copy the text from your PDF and paste it in.");
      return;
    }

    setUploadError("Unsupported file type. Use .docx or .txt for now.");
  };
      ...
      <div className="ats-root" style={styles.container}>
          ...
          >
            <div style={styles.panelLabelRow}>
              ...
              >
                ...
                {fileName ? fileName : "Upload .docx / .txt"}
              </button>
              <input
                ref={fileInputRef}
                type="file"
            ...
            <textarea
              ...
              placeholder="Paste your resume text here, or drag a .docx/.txt file in..."
              value={resume}
        ...
        {result && (
          <div style={styles.resultsWrap}>
            ...
            <div style={styles.jobSearchBox}>
              <div style={styles.suggestTitle}>Find similar job openings</div>
              <p style={styles.suggestText}>
